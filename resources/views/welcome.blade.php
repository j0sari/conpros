                    ...
                    <div class="grid grid-cols-1 md:grid-cols-1">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><span class=""> PROCESO DE ADMISIÓN – GESTIÓN 2022 </span>  </div>
                            </div>

                            <div class="ml-12">
                                <form name="busca" id="busca"  method="POST" action="resultado">
                                    @csrf
                                    <div class=" text-sm">
