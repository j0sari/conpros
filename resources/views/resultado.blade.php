{{-- <ul>
    ...
    <li><strong>Prospecto: </strong>{{ $prospecto }}</li>
</ul> --}}
...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <div class="max-w-14xl mx-auto sm:px-12 lg:px-8">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-2">
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><span class=""> RESULTADO DE SU CONSULTA </span>  </div>
                            </div>

                            <div class="ml-8">
                                <div class=" text-sm">
                                    <form name="eval" id="eval"  method="POST" action="evaluacion">
                                    @csrf
                                        <div class="card text-black bg-transparent bg-success mb-3" style="max-width: 30rem;">
                                            @foreach ($data1 as $data1)
                                                <div class="card-header">
                                                    <label style="font-size: 8pt;"><b>NOMBRES Y APELLIDOS: </b> </label> 
                                                    <input type="text" size=37 value = "{{ $data1->nombre_completo }}"  id="nombre" name="nombre" readonly> <br>
                                                    <label style="font-size: 8pt;"><b>NÚMERO DE C.I.:</b></label> 
                                                    <input type="text" value= {{ $data1->ci }} id="ci" name="ci" readonly> <br>
                                                    <label style="font-size: 8pt;"><b>NÚMERO DE PROSPECTO:</b></label>
                                                    <input type="text" value= {{ $data1->codigo }} id="codigo" name="codigo" readonly>
                                                </div>
                                            @endforeach
                                            <div class="card-body">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            <!-- <th>ATRIBUTO GENERAL OBTENDO</th> -->
                                                            <td colspan="3">
                                                            <b>ATRIBUTO GENERAL OBTENDO</b> <br>    
                        ...
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><span class="">  ATENCIÓN  </span>  </div>
                            </div>
                            <div class="card text-black bg-transparent bg-success mb-3" style="max-width: 30rem;">
                                <div  class="card-header">
